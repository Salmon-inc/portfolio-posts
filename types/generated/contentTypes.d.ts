...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hasDetailPage: Attribute.Boolean &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    ThumImageOnly: Attribute.Boolean &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
      ...
      Attribute.DefaultTo<false>;
    ThumArticleOn: Attribute.Boolean &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    post_tag: Attribute.String & Attribute.Unique;
